...
- [1] Le visualisation de position d'exoplanètes utilisé dans ;a vidéo est disponible à https://github.com/Vincent-Therrien/planedo.
  Il utilise des données du "Nasa Exoplanet Archive", disponible à https://exoplanetarchive.ipac.caltech.edu/
- [2] Okay let's compute this:
  - According to https://size-charts.com/topics/tennis-ball-size-guide-and-dimensions/, the average
    diameter of a tennis ball is 6.6 cm (0.066 m).
  - According to https://www.jpl.nasa.gov/_edu/pdfs/scaless_reference.pdf, the Sun has a diameter of
    1 391 400 km (1 391 400 000 m).
  - According to https://en.wikipedia.org/wiki/Proxima_Centauri, the distance to Proxima Centauri
    is 4.2465 light years (4.017486e16 m, taking 1 ly = 9.4607e15 m, according to
    https://en.wikipedia.org/wiki/Light-year).
  - Let the Sun the be size of a tennis ball. The Sun-Proxima Centauri distance becomes:
  - New distance = (diameter of the tennis ball) (real distance) / (diameter of the Sun)
  - New distance = 0.066 m * 4.017486e16 m / 1.391e9 = 1 905 664 m ~ 1 906 km
  - The distance from Beijing to Hong Kong is around 1950 km.
- [3] Let's calculate how likely it would be for an alien civilization to detect Earth via transit:
  - The Sun has a diameter of 1 391 400 km [2].
  - The Earth orbits the Sun at an average distance of 149 600 000 km, according to
    https://www.jpl.nasa.gov/_edu/pdfs/scaless_reference.pdf
  - Let's suppose the alien civilization looks at us from a *very* far distance, like multiple
    light years.
  - Then we can approximate their perspective as if they are observing Earth from an infinite distance.
  - Let's also approximate the orbit of the Earth as a perfect circle.
  - Let an angle of 0 degree indicate that the Earth makes a perfect transit with the Sun (from
    the perspective of the alien civilization). +90 degrees means that the orbit of the Earth is
    perpendicular to their line of sight.
  - Since they are looking at us from an "infinite" distance, the orbit of the Earth can rotate by
    at most what would make the Earth travel the radius of the Sun from its perfect transit position.
  - If the orbit is rotated less than that, the Earth transits. Otherwise, it does not.
  - Therefore, we can calculate the probability of transit, P, as follows:
  - P = (radius of the Sun) / (Earth-Sun distance)
  - This holds for **small** angles, i.e. we assume that the radius of the Sun is small compared to
    the Sun-Earth distance (it's the case here)
  - P = (1 391 400 km / 2) / (149 600 000 km) = 0.00465 = 0.465 %
  - This is equation (8) in "The Photometric Method of Detecting Other Planetary Systems" by
    William J. Borucki AND Audrey L. Summers
    https://ia600108.us.archive.org/view_archive.php?archive=/24/items/wikipedia-scholarly-sources-corpus/10.1016%252F0014-2999%252883%252990494-6.zip&file=10.1016%252F0019-1035%252884%252990102-7.pdf
- [4] ETH Zürich. CHAPTER 3. TRANSITS OF PLANETS: MEAN DENSITIES (consulted March 24, 2026).
  https://ethz.ch/content/dam/ethz/special-interest/phys/particle-physics/quanz-group-dam/documents-old-s-and-p/Courses/ExtrasolarPlanetsFS2016/exop2016_chapter3_part2.pdf
- [5] NASA. "Kepler / K2" (Consulted March 6, 2026). https://science.nasa.gov/mission/kepler/
- [6] NASA. "The Kepler Mission Star Field" (2007). https://www.nasa.gov/wp-content/uploads/2009/07/189566main_kepler_mission.pdf?emrc=63e454
- [7] "Exoplanet and Candidate Statistics" (Consulted March 8, 2026) https://exoplanetarchive.ipac.caltech.edu/docs/counts_detail.html
- [8] Matthew Williams. "What is the Gravitational Microlensing Method?" (2018). Universe Today.
  https://www.universetoday.com/articles/gravitational-microlensing-method
- [9] Maja Jablonska et al. "Microlensing events over the galactic map as observed by GAIA from 2014 to 2018".
  ESA/Gaia/DPAC. https://en.wikipedia.org/wiki/Gravitational_microlensing#/media/File:MicrolensingGAIA.gif
- [10] B. Scott Gaudi. "Microlensing Surveys for Exoplanets" (2012). Annual Review Astronomy and Astrophysics.
  https://doi.org/10.1146/annurev-astro-081811-125518
- [11] IREX. "Comment les trouver?" (Consulted March 6, 2026).
  https://exoplanetes.umontreal.ca/exo-101/comment-les-trouver/
- [12] NASA Exoplanet Archive. "Radial Velocity Planet Resources in the Exoplanet Archive" (Consulted March 6, 2026).
  https://exoplanetarchive.ipac.caltech.edu/docs/rv.html
- [13] European Southern Observatory. "VLT capta “el primero” a un exótico exoplaneta" (Consulted March 6, 2026).
  https://www.eso.org/public/spain/images/potw1624a/
- [14] Chien-Hsiu Lee and Po-Shih Chiang. "Evidence that the Planetary Candidate CVSO30c is a Background Star from Optical, Seeing-limited Data" (2018).
  The Astrophysical Journal Letters. https://iopscience.iop.org/article/10.3847/2041-8213/aaa40b
- [15] V. Rajpaul, S. Aigrain, S. Roberts. "Ghost in the time series: no planet for Alpha Cen B" (2015).
  Monthly Notices of the Royal Astronomical Society: Letters.
  https://academic.oup.com/mnrasl/article/456/1/L6/2589529?guestAccessKey=
- [16] Xavier Dumusque et al. "An Earth-mass planet orbiting a Centauri B" (2012). Nature.
  https://www.nature.com/articles/nature11572
  - NOTE: The results presented in this paper were disproven by [15], but I'm using this paper
    because it explains why radial velocity is difficult with this star system.
- [17] NASA. "TESS (Transiting Exoplanet Survey Satellite)" (consulted March 10, 2026). https://science.nasa.gov/mission/tess/
- [18] Akshata Krishnamurthy et al. "Transit Search for Exoplanets around Alpha Centauri A and B with ASTERIA" (2021).
  The Astronomical Journal. https://iopscience.iop.org/article/10.3847/1538-3881/abf2c0
- [19] Two references:
  - NASA. "TRAPPIST-1 e" (Consulted March 7, 2026). https://science.nasa.gov/exoplanet-catalog/trappist-1-e/
  - NASA. "James Webb Telescope Discovers TRAPPIST-1 e Lacks Primary Atmosphere" (Consulted March 7, 2026).
    https://www.jameswebbdiscovery.com/discoveries/james-webb-telescope-discovers-trappist-1-e-lacks-primary-atmosphere
- [20] "TOLIMAN Space Telescope" (Consulted March 7, 2026). https://en.wikipedia.org/wiki/TOLIMAN
- [21] European Space Agency. "Plato - Terrestrial planet hunter" (Consulted March 7, 2026).
  https://www.esa.int/Science_Exploration/Space_Science/Plato
- [22] NASA. "Roman" (Consulted March 7, 2026). https://science.nasa.gov/mission/roman-space-telescope/
- [23] NASA. "Habitable Worlds Observatory" (Consulted March 7, 2026).
  https://science.nasa.gov/astrophysics/programs/habitable-worlds-observatory/
- [24] Breakthrough Initiative. "Starshot" (Consulted March 7, 2026). https://breakthroughinitiatives.org/initiative/3
  - That website mentions a speed of "up to 100 million miles an hour", which corresponds to around 15 % the speed of light.
- [25] Breakthrough Initiative. "Concept" (Consulted March 7, 2026). https://breakthroughinitiatives.org/concept/3
- [26] Sarah Scoles. "How a Billionaire’s Plan to Reach Another Star Fell Apart" (2025). Scientific American.
  https://www.scientificamerican.com/article/the-quiet-demise-of-breakthrough-starshot-a-billionaires-interstellar/
- [27] Slava Turyshev. "Direct Multipixel Imaging and Spectroscopy of an Exoplanet with a Solar Gravitational Lens Mission" (2020).
...
- [28] NASA. "NASA Astrobiology Strategy 2015" (2015).
  https://astrobiology.nasa.gov/nai/media/medialibrary/2015/10/NASA_Astrobiology_Strategy_2015_151008.pdf
- [29] Zack Savitsky. "Mars had long-lived magnetic field, extending chances for life" (2022). Science.
  https://www.science.org/content/article/mars-had-long-lived-magnetic-field-extending-chances-life
- [30] Alexandra Witze. "Exoplanet hunters rethink search for alien life" (2017). Nature. https://www.nature.com/articles/nature.2017.23023
- [31] Erik Gregersen. "red dwarf star" (2026). Britannica. https://www.britannica.com/science/red-dwarf-star
- [32] Charles Q. Choi. "Planets Orbiting Red Dwarfs May Stay Wet Enough for Life" (2015). Astrobiology.
  https://web.archive.org/web/20150921050613/http://www.astrobio.net/news-exclusive/planets-orbiting-red-dwarfs-may-stay-wet-enough-life/
- [33] Andrew J. LePage. "Habitable Moons" (2006). Sky and Telescope.
  https://skyandtelescope.org/astronomy-news/habitable-moons/
- [34] NASA. "Ocean Worlds: Water in the Solar System and Beyond" (2023).
  https://science.nasa.gov/solar-system/ocean-worlds/
- [35] Nicolás Lira et al. "ALMA Unveils New Details of the Flares of Proxima Centauri"
  Atacama Large Millimeter/submillimeter Array.
  https://www.almaobservatory.org/en/press-releases/alma-unveils-new-details-of-the-flares-of-proxima-centauri/
- [36] Bruce Dorminey. "Photosynthesis May Limit Complex Life Around Red Dwarf Stars" (2025). Forbes.
  https://www.forbes.com/sites/brucedorminey/2025/09/15/photosynthesis-may-limit-complex-life-around-red-dwarf-stars/
- [37] J. Horner, B. W. Jones. "Jupiter - friend or foe? I: the asteroids" (2008). arXiv. https://arxiv.org/abs/0806.2795
- [38] J. Laskar, F. Joutel, P. Robutel. "Stabilization of the Earth's obliquity by the Moon" (1993). Nature. https://doi.org/10.1038/361615a0
- [39] Govert Schilling. "Who Needs a Moon?" (2011). Science. https://www.science.org/content/article/who-needs-moon
- [40] M. Gillman, R. Zhang. "Generation of a galactic chronology with impact ages and spiral arm tangents" (2024).
  Science Report. https://doi.org/10.1038/s41598-024-56397-4
- [41] Guillermo Gonzalez, Donald Brownlee, Peter Ward. "The Galactic Habitable Zone I. Galactic Chemical Evolution" (2001).
  arXiv. https://arxiv.org/abs/astro-ph/0103165
- [42] David Darling. "Ammonia-based Life" (2016). https://www.daviddarling.info/encyclopedia/A/ammonialife.html
- [43] Luis A. Anchordoqui and Eugene M. Chudnovsky. "Can Self-Replicating Species Flourish in the Interior of a Star?"
  (2020). Letters in High Energy Physics. https://www.researchgate.net/publication/343973117_Can_Self-Replicating_Species_Flourish_in_the_Interior_of_a_Star
- [44] NASA. "NASA Decadal Astrobiology Research and Exploration Strategy". https://science.nasa.gov/astrobiology/strategy/dares/
- [45] Brian Koberlein. "Could Stars Hotter Than the Sun Still Support Life?" (2024). Universe Today.
...
- Planet sizes and distances: https://www.jpl.nasa.gov/_edu/pdfs/scaless_reference.pdf
- Radial velocity: https://nexsci.caltech.edu/workshop/2020/
- Direct imaging: https://en.wikipedia.org/wiki/Methods_of_detecting_exoplanets#/media/File:444226main_exoplanet20100414-a-full.jpg
- Launch of Kepler: https://www.youtube.com/watch?v=OVfyjqGphuc
- The Sun: https://images.nasa.gov/details/GSFC_20171208_Archive_e001435
- Tennis ball: https://pixabay.com/vectors/tennis-ball-yellow-sport-game-2025095/
- Night sky: https://www.pexels.com/video/time-lapse-of-a-starry-night-sky-8644731/
  by Bohdan Borovyk (https://www.pexels.com/@bohdan-borovyk-76947366/)
- Artist's impression of the Milky Way: https://commons.wikimedia.org/wiki/File:Artist%E2%80%99s_impression_of_the_Milky_Way.jpg
- Microlensing (galaxy + star): https://en.wikipedia.org/wiki/File:Artist%27s_impression_of_gravitational_lensing_of_a_distant_merger.ogv
- Microlensing diagram for exoplanets: https://science.nasa.gov/mission/roman-space-telescope/microlensing/
- Microlensing events in the galaxy: https://commons.wikimedia.org/wiki/File:MicrolensingGAIA.gif
- Observation methods: https://www.esa.int/Science_Exploration/Space_Science/Exoplanets/How_to_find_an_exoplanet
- Solar sail: https://en.wikipedia.org/wiki/Solar_sail#/media/File:Advanced_Composite_Solar_Sail_System_deployment.gif
- Distance to ALpha Centauri chart:
  - Distance to Alpha Centauri: 4.017486e16 m, refer to [2]
    - This corresponds to 4.017486e16 m / 1.495979e11 = 268554 AU
  - Distance to Voyager 1 as of March 2026: 25.40 billion km = 25.40e9 km = 2..54e10 km = 2.54e13 m, refer to https://science.nasa.gov/mission/voyager/where-are-voyager-1-and-voyager-2-now/
    - 2.54e13 m / 1.495979e11 = 169.79 AU
  - Neptune is at a distance of 30.06 AU
- Earth`s atmosphere: https://images.nasa.gov/details/iss074e0089803
- Earth`s magnetic field: https://images.nasa.gov/details/GSFC_20180509_MMS_m12901_Turbulent_Magnetosheath
- Earth / Mars atmosphere comparison: https://images.nasa.gov/details/PIA15953
- Mars: https://images.nasa.gov/details/PIA22905
- Kepler 22 b (artist's impression): https://eyes.nasa.gov/apps/exo/#/planet/Kepler-22_b
- Proxima Centauri (artist's impression): https://eyes.nasa.gov/apps/exo/#/star/Proxima_Cen
- TRAPPIST-1 f: https://en.wikipedia.org/wiki/Eyeball_planet#/media/File:TRAPPIST-1f_Artist's_Impression.png
- Earth's terminator: https://en.wikipedia.org/wiki/Terminator_(solar)#/media/File:Apollo_11_Mission_Image_-_View_of_Earth_terminator_(5052744816).jpg
- Exomoon animation: https://images.nasa.gov/details/JPL-20241009-EXOPLNf-0001-NASA_Detects_Possible_Volcanic_MoonCC
- Io: https://images.nasa.gov/details/PIA00738
- Enceladus: https://images.nasa.gov/details/JPL-2015_10_28-PIA17202
- Europa: https://images.nasa.gov/details/PIA02528
- Solar system: https://images-assets.nasa.gov/image/PIA22921/PIA22921~orig.jpg
- The Moon: https://images.nasa.gov/details/GSFC_20171208_Archive_e001982
